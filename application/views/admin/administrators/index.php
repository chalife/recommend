  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="/admin/administrators"><?php echo $page_title ?></a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><a href="/admin/administrators/edit" class="btn btn-block btn-primary btn-flat"><i class="fa fa-plus"></i> 添加</a></h3>

              <div class="box-tools">
				<form action="/admin/administrators" method="get">
            ...
            <div class="box-footer clearfix">
				...
				<div class="row">
				    <div class="col-sm-5">
					    <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">显示<?=$administrators_show_begin?>-<?=$administrators_show_end?>条，共<?=$administrators_total_rows?>条</div>
					</div>
					<div class="col-sm-7">
