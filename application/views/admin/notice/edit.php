...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/admin/notice">通知列表</a></li>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-plus"></i> 编辑通知</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form action="/admin/notice/edit" class="form-horizontal" id="createForm" method="post"
                                      accept-charset="utf-8">
                                    <input type="hidden" name="id" value="<?= $data->id ?>"/>
                                    <div class="form-group">
                                        <label for="last_name" class="col-sm-2 control-label">内容</label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <a href="/admin/notice" class="btn btn-default btn-flat">取消</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
