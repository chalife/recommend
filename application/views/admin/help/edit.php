...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/admin/help">帮助列表</a></li>
            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-plus"></i> 新增帮助</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <form action="/admin/help/edit" class="form-horizontal" id="createForm" method="post"
                                    ...
                                    <div class="form-group">
                                        <label for="last_name" class="col-sm-2 control-label">答案</label>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <a href="/admin/help" class="btn btn-default btn-flat">取消</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
