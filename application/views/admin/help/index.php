...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="/admin/help"><?php echo $page_title ?></a></li>
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><a href="/admin/help/edit" class="btn btn-block btn-primary btn-flat"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button data-toggle="modal" data-target="#boxModal"
                                                onclick="loadModal('/admin/help/del/<?= $role->id ?>')"
                                                class="btn btn-danger btn-sm pull-right"><i class="fa fa-remove"></i> 删除
                                        </button>
                                        <a href="/admin/help/edit/<?= $role->id ?>"
